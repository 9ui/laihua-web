<template>
  <div class="w-56 min-w-0 bg-white rounded-lg shadow-lg" style="margin: 100px auto;">
    <ul class="p-2 space-y-1">
      <li class="relative">
        ...
        >
          ...
          <span>分享</span>
          <svg
            class="w-4 h-4 ml-auto sm:hidden"
            :class="{ 'transform rotate-180': open1 }"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <svg
            class="hidden w-4 h-4 ml-auto sm:block"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <ul class="p-2 space-y-1">
      <li>
        <button class="flex items-center min-w-full px-2 py-1 rounded hover:bg-gray-200">
          <svg
            class="w-4 h-4 mr-3"
            fill="none"
            stroke="currentColor"
