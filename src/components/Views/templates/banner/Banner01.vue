<template>
  <!-- Section 1 -->
  <section
    class="relative flex flex-col items-center justify-center w-full px-6 py-24 bg-white bg-cover lg:py-32 min-w-screen"
  >
    <div
    ...
    >
      ...
      >
        <h1
          class="relative z-20 text-3xl font-extrabold leading-none text-purple-500 xl:text-4xl sm:text-center lg:text-left"
        >
          <span class="mt-1 text-gray-800 lg:mt-0">视频简历</span>面对面<span
            class="mt-1 text-gray-800 lg:mt-0"
            >的仪式感</span
          >
        </h1>
        <p
          class="relative z-20 block mt-6 text-base text-gray-500 xl:text-xl sm:text-center lg:text-left"
          >一秒吸引面试官眼球<br />让视频简历变得更酷炫</p
        >
        <div class="relative flex mt-4">
          ...
          >
            ...
            <span class="text-purple-500">开始演示</span>
          </a>
        </div>
      </div>
