      ...
      <div class="container mx-auto px-4">
        <div class="max-w-xl mx-auto mb-10 text-center">
          ...
          <h2 class="text-4xl lg:text-5xl font-bold font-heading"
            >Check our awesome team members</h2
          >
        </div>
        <div class="flex flex-wrap">
          <div class="mb-6 w-full md:w-1/2 lg:w-1/3 px-3">
            <div class="py-24 bg-white rounded shadow text-center">
              <img
                class="mx-auto mb-8 w-24 h-24 rounded-full object-cover"
          ...
          <div class="mb-6 w-full md:w-1/2 lg:w-1/3 px-3">
            <div class="py-24 bg-white rounded shadow text-center">
              <img
                ...
                alt=""
              />
              <h4 class="mb-2 text-2xl font-bold font-heading">Alice Bradley</h4>
          ...
          <div class="mb-6 w-full md:w-1/2 lg:w-1/3 px-3">
            <div class="py-24 bg-white rounded shadow text-center">
              <img
                ...
                alt=""
              />
              <h4 class="mb-2 text-2xl font-bold font-heading">Sahra Ortiz</h4>
