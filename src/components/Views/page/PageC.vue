      ...
      <div class="px-6 mx-auto max-w-7xl">
        <div class="flex items-center justify-between h-20">
          ...
          <div class="flex items-center space-x-8">
            <a href="#_" class="font-bold text-gray-900">示例</a>
            <a href="#_" class="px-4 py-2 font-bold text-white bg-gray-900 rounded-md">现在注册</a>
          </div>
        </div>
        ...
        >
          ...
          <div class="relative flex-1 w-full pt-6 text-black lg:pt-12 lg:pl-12 lg:w-6/12">
            <!-- Start of Image -->
            <img
              src="https://cdn.devdojo.com/images/january2021/hero-character.png"
              class="w-full"
            />
            <!-- End of Image -->
          </div>
      ...
      <div class="w-full px-20 mx-auto text-left md:px-10 max-w-7xl xl:px-16">
        <div class="box-border flex flex-col flex-wrap justify-center -mx-4">
          <div class="relative w-full mb-12 leading-6 text-left xl:flex-grow-0 xl:flex-shrink-0">
            <h2
              class="box-border mx-0 mt-0 font-sans text-4xl font-bold text-center text-indigo-900"
            >
              和行业大咖一起体验来画
            </h2>
            <p class="w-full mt-2 text-center text-indigo-800">关于来画，他们这样说...</p>
          </div>
        </div>
        <div
        ...
        >
          <div class="flex col-span-1">
            ...
            <div class="relative px-4 mb-16 leading-6 text-left">
              <div class="box-border text-lg font-medium text-gray-600">
                画解决了我们快速做动画类短视频产出效率的问题，内置的很多场景和动态素材只需要简单拖拽到画布，设置好简单的参数，就可以做出一段生动的视频片段.
              </div>
          ...
          <div class="flex col-span-1">
            ...
            <div class="relative px-4 mb-16 leading-6 text-left">
              <div class="box-border text-lg font-medium text-gray-600">
                来画把技术与艺术完美融合，通过新颖有趣、极具创意的动画形式为京东平台海量品牌和商家创作了无数精彩的作品
              </div>
              <div class="box-border mt-5 text-sm font-semibold text-indigo-900 uppercase">
                于晓雷
              </div>
          ...
          <div class="flex col-span-1">
            ...
            <div class="relative px-4 mb-5 leading-6 text-left">
              <div class="box-border text-lg font-medium text-gray-600">
                在做品牌营销策划时，产品宣传需要做视频，文字表达不够吸引眼球。来画视频以简单有趣、生动的视频形式提高了策划效率
              </div>
              <div class="box-border mt-5 text-sm font-semibold text-indigo-900 uppercase">
                陈鹤平
              </div>
