<template>
  ...
  >
    ...
    <div v-else key="skeleton" name="lazy-skeleton">
...
<script lang="ts">
  import { defineComponent, reactive, onMounted, ref, toRef, toRefs } from '@vue/composition-api';
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function initIntersectionObserver() {
        ...
        try {
          const { stop, io } = useIntersectionObserver({
