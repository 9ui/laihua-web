<template>
  <svg viewBox="0 0 266 150" fill="none">
    ...
    <path
      ...
      fill="var(--solid-900)"
    />
    <path d="M20 60a3 3 0 013-3h6a3 3 0 110 6h-6a3 3 0 01-3-3z" fill="var(--base-300)" />
    ...
    <path
      ...
      fill="var(--solid-900)"
    />
    <path d="M99 60a3 3 0 013-3h6a3 3 0 110 6h-6a3 3 0 01-3-3z" fill="var(--base-300)" />
    ...
    <path
      ...
      fill="var(--solid-900)"
    />
    <path d="M178 60a3 3 0 013-3h6a3 3 0 110 6h-6a3 3 0 01-3-3z" fill="var(--base-300)" />
