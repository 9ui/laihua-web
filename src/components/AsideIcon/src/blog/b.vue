<template>
  <svg viewBox="0 0 266 150" fill="none">
    ...
    <rect x="20" y="43" width="68" height="63" rx="2" fill="var(--base-200)"></rect>
    <path
    ...
    <path
      ...
      fill="var(--solid-900)"
    ></path>
    <rect x="99" y="43" width="68" height="63" rx="2" fill="var(--base-200)"></rect>
    <path
    ...
    <path
      ...
      fill="var(--solid-900)"
    ></path>
    <rect x="178" y="43" width="68" height="63" rx="2" fill="var(--base-200)"></rect>
    <path
