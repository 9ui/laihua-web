<template>
  <svg viewBox="0 0 266 150" fill="none">
    ...
    <rect x="20" y="37" width="74" height="5" rx="2.5" fill="var(--solid-900)" />
    <rect x="20" y="112" width="26" height="5" rx="2.5" fill="var(--solid-900)" />
    <rect x="20" y="30" width="38" height="3" rx="1.5" fill="var(--base-400)" />
    <rect x="20" y="55" width="26" height="3" rx="1.5" fill="var(--main-500)" />
    <path
      d="M56 56.5a1.5 1.5 0 011.5-1.5h23a1.5 1.5 0 010 3h-23a1.5 1.5 0 01-1.5-1.5z"
      fill="var(--base-500)"
    />
    <rect x="92" y="55" width="26" height="3" rx="1.5" fill="var(--base-500)" />
    ...
    <path
      ...
      fill="var(--base-300)"
    />
    <rect x="87" y="110" width="31" height="10" rx="2" fill="var(--main-500)" />
